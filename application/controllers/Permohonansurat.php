...
class Permohonansurat extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $data['mahasiswa'] = $this->Mod_user->get_all_mahasiswa();
    ...
    public function insert()
    {
        ...
        $this->fungsi->send_bot($this->session->userdata('full_name'), " Berhasil Melakukan Pengajuan Surat Baru", "PENGAJUAN SURAT");
        helper_log("pengajuan surat", "Berhasil Mengajukan Surat", $this->session->userdata['username']);

        $this->fungsi->send_bot_sekretaris($this->session->userdata('full_name'), " Berhasil Melakukan Pengajuan Surat Baru", "PENGAJUAN SURAT");
        helper_log("pengajuan surat", "Berhasil Mengajukan Surat", $this->session->userdata['username']);
    ...
    {
        $id_role = $this->Mod_userlevel->getId('Kasenat');
        // $id_kasenat = $this->Mod_user->get_user_by_role($id_role->id_level);
        $data['kasenat'] = $this->Mod_user->get_user_by_role($id_role->id_level);
        $data['surat'] = $this->Mod_permohonan_surat->get_surat_by_id($id);
        $data['lampiran'] = $this->Mod_lampiran->get_lampiran_by_id($id);
