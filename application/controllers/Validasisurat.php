    ...
    public function validasi()
    {
        ...
        if ($checklevel == 'Sekretaris') {
            ...
            if ($this->input->post('status_kasenat') == 'Diproses') {
                ...
                $params['data'] = 'Surat ini telah disahkan dan divalidasi oleh KETUA SENAT PMIK NIM '. $this->session->userdata('nim_nrp') .' a/n ' . $this->session->userdata('full_name') . ' pada ' . tgl_indonesia(date('Y-m-d H:i:s')) . ' melalui Sistem E-Nota Dinas'; //data yang akan di jadikan QR CODE
