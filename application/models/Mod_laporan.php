...
class Mod_laporan extends CI_Model
{
    ...
    var $column_order = array('', 'id_laporan', 'nama_lengkap', 'imei', 'no_telepon', 'email', 'deskripsi');
    var $column_search = array('id_laporan', 'nama_lengkap', 'imei', 'no_telepon', 'email', 'deskripsi');
