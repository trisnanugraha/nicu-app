...
class Mod_mahasiswa extends CI_Model
{
    ...
    {
        $this->db->select('a.*,b.nama_level,c.nama_angkatan as angkatan,d.nama_sindikat');
        $this->db->join('tbl_userlevel b', 'a.id_level=b.id_level');
        $this->db->join('tbl_angkatan c', 'a.id_angkatan=c.id_angkatan');
        $this->db->join('tbl_sindikat d', 'a.id_sindikat=d.id_sindikat');
        $this->db->from('tbl_user a');
        $this->db->where('b.id_level', $level);
    ...
    {
        $this->db->select('a.full_name, a.nim_nrp, a.alamat, a.no_hp, b.nama_sindikat, c.nama_angkatan');
        $this->db->join('tbl_sindikat b', 'a.id_sindikat=b.id_sindikat');
        $this->db->join('tbl_angkatan c', 'a.id_angkatan=c.id_angkatan');
        $this->db->where('a.id_angkatan', $id);
