...
<body class="register-page clear-height" style="display: block;">
    <div class="register-box" style="display: block; margin: 50px auto;">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body register-card-body">
                <form action="" method="post" id="signup-form">
                    ...
                    <div class="form-group">
                        <label for="judul" class="col-form-label">NIM / NRP <span style="color: red;">*</span></label>
                        <div class="input-group kosong">
