            ...
            <div class="body-surat">
                ...
                <table id="tujuan-surat" border="0">
                    ...
                    <tr>
                        ...
                        <td class="rata-atas"><?php echo $mhs->full_name; ?></td>
                    </tr>
                    <tr>
                        <td class="rata-atas">2.</td>
                        <td class="rata-atas">No.Mhs/Sin</td>
                        <td class="rata-atas-tengah">:</td>
                        <td class="rata-atas"><?php echo $mhs->nim_nrp; ?>/<?php echo $mhs->nama_sindikat; ?></td>
                    </tr>
                    <tr>
                ...
                <table class="penutup-surat" border="0">
                    <tr>
                        ...
                        <td>:</td>
                        <?php if ($surat->status_kakorwa == 'Disetujui') { ?>
                            <td>Jakarta</td>
                        <?php } ?>
                    </tr>
                    <tr>
                    ...
                    <?php if ($surat->status_kakorwa == 'Disetujui') { ?>
                        <tr>
                            <td style="text-align: center;" colspan="3">KAKORWA</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;" colspan="3"><img style="width: 100px;" src="<?php echo base_url() . '/assets/qr-code-ibl/' . $surat->id_ibl . '.png'; ?>"></td>
                        </tr>
                        <tr>
                            <td style="text-align: center;" colspan="3"><?php echo $kakorwa->full_name; ?><br> <span class="border-top">KOMISARIS BESAR POLISI NRP <?php echo $kakorwa->nim_nrp; ?></span></td>
                        </tr>
                    <?php } ?>
                </table>
                <div id="tembusan">
