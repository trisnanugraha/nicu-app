  ...
  function detail(id) {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.natrium >= 136 && data.natrium <= 145) {
        ...
        if (data.kalium >= 3.5 && data.kalium <= 5.1) {
        ...
        if (data.kalsium >= 7.6 && data.kalsium <= 10.4) {
        ...
        if (data.bilirubin_total >= 0.14 && data.bilirubin_total <= 14.44) {
        ...
        if (data.albumin >= 3.3 && data.albumin <= 4.4) {
