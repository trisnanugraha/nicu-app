...
<body>
    <div class="page">
        ...
        <div class="body-surat">
            ...
            <div>
                <div>Jakarta, <?php echo $surat->tgl_diubah; ?></div><br>
                <img style="width: 100px;" src="<?php echo base_url() . '/assets/qr-code/' . $surat->qr_nota; ?>">
                <br><?php echo $kasenat->full_name; ?><br> <span class="border-top">MAHASISWA / NIM <?php echo $kasenat->nim_nrp; ?></span>
                <!-- <table class="penutup-surat">
                    ...
                    <tr>
                        <td><?php echo $kasenat->full_name; ?><br> <span class="border-top">MAHASISWA / NIM <?php echo $kasenat->nim_nrp; ?></span></td>
                    </tr>
                </table> -->
                <div id="tembusan">
                    <p>Tembusan</p>
