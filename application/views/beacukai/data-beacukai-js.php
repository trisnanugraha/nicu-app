<script type="text/javascript">
    ...
    $(document).on("click", ".edit", function() {
        ...
        $.ajax({
            url: "<?php echo site_url('databeacukai/edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                ...
                $('[name="no_penerbangan"]').val(data.no_penerbangan);
                $('[name="tipe_hp"]').val(data.tipe_hp);
                $('[name="model_hp"]').val(data.model_hp);
    ...
    function save() {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('databeacukai/insert') ?>";
        } else {
            url = "<?php echo site_url('databeacukai/update') ?>";
        }
